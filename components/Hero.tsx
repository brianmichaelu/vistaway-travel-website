    ...
    <section id="home" className="relative scroll-mt-[72px] md:scroll-mt-[88px]">
      <div className="relative flex w-full items-center justify-center overflow-hidden px-4 py-10 sm:px-6 md:min-h-[calc(100vh-88px)] md:py-16">
        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl text-center">
          ...
          <h1 className="mx-auto max-w-4xl text-[31px] font-black leading-[1.08] text-[#FFF8EF] drop-shadow-2xl sm:text-5xl lg:text-[58px]">
            Flights, Visas & Holiday Packages Made Simple
          </h1>

          <p className="mx-auto mt-4 max-w-3xl text-[15px] leading-7 text-[#D9F7EF] drop-shadow md:text-lg md:leading-8">
          ...
          <div className="mx-auto mt-6 flex w-full max-w-sm flex-col items-stretch justify-center gap-3 sm:max-w-none sm:flex-row sm:items-center sm:gap-4">
            <a
              href="#flights"
              className="inline-flex cursor-pointer items-center justify-center rounded-full bg-[#FF6B5E] px-5 py-3 text-[12px] font-black uppercase tracking-wide text-white shadow-xl transition hover:-translate-y-1 hover:bg-[#f45e51] sm:px-7 sm:py-4 sm:text-sm"
            >
            ...
            <a
              href="#dubai-visa"
              className="inline-flex cursor-pointer items-center justify-center rounded-full bg-[#D9F7EF] px-5 py-3 text-[12px] font-black uppercase tracking-wide text-[#064E4A] shadow-xl transition hover:-translate-y-1 hover:bg-[#FFF8EF] sm:px-7 sm:py-4 sm:text-sm"
            >
      ...
      <a
        ...
        className="fixed bottom-5 right-4 z-[999] flex h-[46px] w-[46px] cursor-pointer items-center justify-center rounded-full bg-[#25D366] text-2xl text-white shadow-2xl transition hover:-translate-y-1 hover:scale-105 md:right-8"
